                    ...
                    <div className="flex">
                      <div className="bg-white/10 backdrop-blur-lg rounded-2xl px-8 py-12 border border-white/20 w-full flex flex-col">
                        ...
                        <div className="space-y-4 flex-grow">
                          ...
                          <div className="flex items-start gap-4">
                            <div className="flex-shrink-0 w-8 h-8 bg-chambry-500 rounded-full flex items-center justify-center">
                              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                              </svg>
                            </div>
                            <div>
                              <h4 className="font-bold text-green-400 text-lg">"Future-Proof Parent" Guide!</h4>
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              <h4 className="font-bold text-blue-400 text-lg">Digital Confidence Guarantee!</h4>
